<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/Enats_attendance/admin/');
define('HTTP_CATALOG', 'http://localhost/Enats_attendance/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/Enats_attendance/admin/');
define('HTTPS_CATALOG', 'http://localhost/Enats_attendance/');

// DIR
define('DIR_APPLICATION', 'C:/xampp/htdocs/Enats_attendance/admin/');
define('DIR_SYSTEM', 'C:/xampp/htdocs/Enats_attendance/system/');
define('DIR_IMAGE', 'C:/xampp/htdocs/Enats_attendance/image/');
define('DIR_LANGUAGE', 'C:/xampp/htdocs/Enats_attendance/admin/language/');
define('DIR_TEMPLATE', 'C:/xampp/htdocs/Enats_attendance/admin/view/template/');
...
define('DIR_CATALOG', 'C:/xampp/htdocs/Enats_attendance/catalog/');
